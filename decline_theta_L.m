% Downhill ('decline') - Lower Leg ('L')

function pp = decline_theta_L()

addpath code

Orientation.Y = readmatrix('data\decline_theta_L.xlsx', 'Range', 'C:C');
...
my_title('\textbf{Downhill --- Lower Leg}')

my_print decline_theta_L
